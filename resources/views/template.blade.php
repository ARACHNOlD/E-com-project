...
<body>
    ...
    <header>
        <a href="" class="logo"><img src="c:\Users\glory\Desktop\LOGO\logo1.png"
         alt="" ></a>
         <ul class="nav-menu">
            <li><a href="">Home</a></li>
            <li><a href="">Shop</a></li>
    ...
    <section id="topheader">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <a href="" class="logo"><img src="c:\Users\glory\Desktop\LOGO\logo1.png"></a>
                </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3">
                            <h1 class="display-4 text-white mb-3">Shop More Save More
                            </h1>
                            <p class="mx-md-5 px-5">Get 30% Off in every product</p>
                ...
                <picture>
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3">
                            <h1 class="display-4 text-white mb-3">30% Off on every product</h1>
